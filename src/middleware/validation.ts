...
export const validateMyRestaurantRequest = [
    ...
    body("deliveryPrice").isFloat({ min: 0}).notEmpty().withMessage("Delivery price must be a postive value"),
    body("estimatedDeliveryTime").isInt({ min: 0}).notEmpty().withMessage("Estimated delivery time must be a positive value"),
